        ...
        <div className="chat-input-area">
            ...
            <div className={`input-row${!userInput ? ' is-empty' : ''}`} style={{ position: 'relative' }}>
                <textarea
                    ...
                    placeholder={!isAIReady ? "请先在设置中配置 API Key" : "输入消息..."}
                    onKeyDown={(e) => {
                        if (e.key === "Enter") {
                ...
                <div className="input-controls">
                    ...
                    <div className="input-controls-right">
                        {isLoading ? (
                            <button onClick={handleStopGeneration} className="stop-generating-btn" title="停止生成">
                            ...
                            <button
                                ...
                                disabled={!isAIReady || (!userInput.trim() && attachedFiles.length === 0 && lastMessage?.role !== 'user') || editingMessageIndex !== null}
                                title="发送消息"
                            >
