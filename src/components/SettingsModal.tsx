                                    ...
                                    <div className="add-model-section">
                                        ...
                                        <div className="add-model-row">
                                            <input
                                                ...
                                                placeholder="模型 ID (例如: claude-3-7-sonnet@20250219)"
                                                value={newModelId}
                                                ...
                                                <button className="icon-btn add-model-submit-btn" onClick={() => addModel(selectedProvider.id)} disabled={!newModelId} title={editingModelId ? "更新模型" : "添加模型"}>
                                                    {editingModelId ? (
                                                        ...
                                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
                                                            <path fillRule="evenodd" d="M8 2a.5.5 0 0 1 .5.5v5h5a.5.5 0 0 1 0 1h-5v5a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 2Z" />
                                                        </svg>
                                                    )}
                                                </button>
                                            </div>
                                        ...
                                        {!editingModelId && selectedProvider.type === 'google' && (
                                            <div className="quick-add-models">
                                                ...
                                                <span className="quick-add-tag" onClick={() => { setNewModelId('gemini-3-flash-preview'); setNewModelName('Gemini 3.0 Flash'); }}>+ Gemini 3.0 Flash</span>
                                                <span className="quick-add-tag" onClick={() => { setNewModelId('gemini-3.1-flash-lite-preview'); setNewModelName('Gemini 3.1 Flash Lite'); }}>+ Gemini 3.1 Flash Lite</span>
